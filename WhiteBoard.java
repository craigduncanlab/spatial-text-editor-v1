...
public WhiteBoard(SpriteTracker spTrk, StageManager parent, ClauseContainer myNode, EventHandler PressBox, EventHandler DragBox) {
    //view
    ...
    //this.myTrk.setCurrentFocus(WhiteBoard.this); //set focus on creation
    //parent.setCurrentFocus(WhiteBoard.this);//this duplicated previous line since class variable?
    //
...
public WhiteBoard(SpriteTracker spTrk, StageManager parent, SpriteBox myBox, EventHandler PressBox, EventHandler DragBox) {
    setJavaFXStageParent(parent);
    setParentBox(myBox); //data 
    //
    //myBox.setChildStage(WhiteBoard.this);
    setPressBox(PressBox);
    setDragBox(DragBox);
    setKeyPress(NodeKeyHandler); //this can be different for workspace
    //
...
EventHandler myMouseLambda = new EventHandler<MouseEvent>() {
 ...
 public void handle(KeyEvent ke) {
    System.out.println("Key Event on current Stage:"+WhiteBoard.this.toString());
...
Refreshes stage from display node, but doesn't show if invisible*/
 ...
 private void displayChildNodeBoxes() {
        ...
        while (myiterator.hasNext()) {
            ...
            System.out.println("WS Viewer :"+WhiteBoard.this);
        ...
        tempScene.addEventFilter(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>() {
         ...
         public void handle(MouseEvent mouseEvent) {
                 ...
                 Rfresh NodeViewScene
                    ...
                    */
                    /*
                 if (!getCurrentFocus().equals(WhiteBoard.this)) {
                     //WhiteBoard.this.myTrk.setCurrentFocus(WhiteBoard.this);
                 }
                 //error checking i.e. like jUnit assert
                 if (getCurrentFocus()==WhiteBoard.this) {
                    System.out.println("Change of Viewer Focus OK in Viewer!");
                     System.out.println("makescene Viewer :"+WhiteBoard.this);
                    ...
                    System.out.println("makescene Present Viewer :"+WhiteBoard.this);
...
EventHandler<MouseEvent> mouseEnterEventHandler = 
        ...
        public void handle(MouseEvent t) {
            ...
            System.out.println("Detected mouse released - Stage Manager Group"+WhiteBoard.this.getSpriteGroup().toString());
            //t.consume();//check
        }
    };
...
//mouse drag
    ...
    EventHandler<MouseEvent> mouseDragEventHandler = 
        ...
        public void handle(MouseEvent t) {
            //SpriteBox currentSprite = ((SpriteBox)(t.getSource()));
            //TO DO: check if mouse is dragging/pressed
            System.out.println("Detected mouse drag - Stage Manager Group"+WhiteBoard.this.getSpriteGroup().toString());
            //t.consume();//check
        }
    };
...
EventHandler<ActionEvent> closeWindow = 
        ...
        public void handle(ActionEvent event) {
           WhiteBoard.this.getStage().close();
        }
    };
...
private Scene makeWorkspaceScene(Group myGroup) {
        ...
        workspaceScene.addEventFilter(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>() {
             ...
             //System.out.println("Workspace is "+WhiteBoard.this.toString());
            ...
            //to distinguish Text on Menu from Text on boxes you can interrogate what the Text is to see if it's a menu
                 ...
                 //this.myTrk.setCurrentFocus(WhiteBoard.this);
            }
...
private void addSpriteToStage(SpriteBox mySprite) {
    ...
    //mySprite.setStageLocation(WhiteBoard.this); //give Sprite the object for use later.
}
...
public void OpenNewNodeNow(ClauseContainer newNode) {
    ...
    /* Modified 25.6.18 so that it always opens as childnode of Whiteboard.  Different to WS

     if (WhiteBoard.this.equals(myWS)) { 
     newNodeForWorkspace(newNode);
...
public void positionSpriteOnStage(SpriteBox mySprite) {
    ...
    /*
    mySprite.setStageLocation(WhiteBoard.this); //needed if stage is not o/w tracked
    if (mySprite.getStageLocation()!=WhiteBoard.this) {
